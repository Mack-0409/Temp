        ...
        >
          <div className={`rounded-3xl p-8 md:p-12 ${isDark ? 'glass' : 'bg-white shadow-xl'}`}>
            <div className="text-center mb-8">
              ...
              <p className={isDark ? 'text-white/60' : 'text-gray-600'}>Sign in to access your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 accent-luxury-red" />
                  <span className={`text-sm ${isDark ? 'text-white/60' : 'text-gray-600'}`}>Remember me</span>
                </label>
                <a href="#" className="text-luxury-red text-sm hover:underline">
                  Forgot password?
                </a>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className={isDark ? 'text-white/60' : 'text-gray-600'}>
                ...
                <Link to="/signup" className="text-luxury-red hover:underline font-medium">
                  Sign Up
                </Link>
              </p>
            </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className={`px-4 ${isDark ? 'bg-transparent text-white/40' : 'bg-white text-gray-500'}`}>or</span>
                </div>
              </div>

              <button className={`w-full mt-6 flex items-center justify-center gap-3 rounded-xl py-3 transition-colors ${
                isDark 
